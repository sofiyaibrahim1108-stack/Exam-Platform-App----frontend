              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  {activeTab === 'academic' ? (
                    ...
                    >
                      ...
                      <div className="relative" ref={dropdownRef}>
                        ...
                        >
                          <Search className="w-4 h-4 shrink-0" style={{ color: '#B33A62' }} />
                          <input
                            type="text"
                      ...
                      {academicRole === 'Staff' ? (
                        <div>
                          ...
                          <div className="auth-input-wrap flex items-center px-3.5 py-3">
                            <BadgeCheck className="w-4 h-4 shrink-0" style={{ color: '#B33A62' }} />
                            <input
                    ...
                    >
                      ...
                      <div className="auth-input-wrap flex items-center px-3.5 py-3">
                        <Mail className="w-4 h-4 shrink-0" style={{ color: '#B33A62' }} />
                        <input
                          {...register('email', {
                ...
                <div>
                  ...
                  <div className="auth-input-wrap relative flex items-center px-3.5 py-3">
                    <Lock className="w-4 h-4 shrink-0" style={{ color: '#B33A62' }} />
                    <input
