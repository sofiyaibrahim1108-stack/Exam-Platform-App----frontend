...
const AUTH_THEME = `
  ...
  #reset-confirm-password-input:focus {
    border: none !important;
    box-shadow: none !important;
  }
  .auth-btn-wine {
              ...
              >
                <div className="w-full max-w-lg">
                  <div className="auth-card p-8 md:p-12">
                    ...
                    <form data-scope="auth" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                      {/* New Password Field */}
                      <div className="space-y-1">
                        <label className="auth-label" htmlFor="reset-password-input">New Password</label>
                      ...
                      <div className="space-y-1">
                        <label className="auth-label" htmlFor="reset-confirm-password-input">Confirm New Password</label>
                        <div className="auth-input-wrap relative flex items-center px-3.5 py-3">
                          <span style={{ fontSize: 16, color: '#B33A62' }}>🔒</span>
                          <input
